...
$(document).ready(function() {
    ...
    var convertedStr = contentStr.replace(/<br>/g, "\r\n");
    ...
    $.ajax({
         ...
         success : function(data) {
            ...
            var str = "";
            if (arr == null) {
               str += "<tr><td colspan=4>등록된 댓글이 없습니다.</td></tr>";
            } else {
               str += "<table style='width:100%;' class=table table-hover>";
               for (i = 0; i < arr.length; i++) {
                  if (id == arr[i].writer) {
                     str += "<tr><td style='width:15%;'>" + arr[i].writer + "</td><td>" + arr[i].content;
                     str += "<input type=hidden id=repNum"+arr[i].num+" value="+arr[i].num+"></td>";
                     str += "<td><input type='button' class='delRep' num="+arr[i].num+" value='삭제'></td></tr>";
                  } else {
                     str += "<tr><td style='width:15%;'>" + arr[i].writer + "</td><td>" + arr[i].content + "</td><td></td></tr>";
                  }
         ...
         <table id="listTable" class="table table-hover" style="max-width: 1000px;">
            ...
            <tr>
               ...
               <td colspan="3">
                  ...
                  <input type="button" class="myButton" id="editNOP" value="참가" num="${c.num }">
                  <input type="button" class="myButton" id="editNOP2" value="참가 취소" num="${c.num }" style="display: none">
            ...
            <tr>
               ...
               <td colspan="3" style="text-align: center;">
                  <div>
                     ...
                     <input type="button" class="myButton" id="add" value="작성" num="${c.num }">
                  </div>
               </td>
            </tr>
            <tr>
               ...
               <c:choose>
                  <c:when test="${sessionScope.id eq c.writer}">
                     <td colspan="5" style="text-align: right;">
                        <input type="button" class="myButton" id="back" value="뒤로">
                        <input type="submit" class="myButton" value="수정">
                        <input type="button" class="myButton" id="del" value="삭제">
                     </td>
                  </c:when>
                  <c:otherwise>
                     <td colspan="5" style="text-align: right;">
