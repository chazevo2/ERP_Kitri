...
<script type="text/javascript">
	$(document).ready(function() {
		$(".select").click(function() {
			...
			location.href = "${pageContext.request.contextPath }/community/editForm1?num=" + num;
		});
