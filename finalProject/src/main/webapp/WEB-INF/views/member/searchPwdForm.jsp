...
<body>
    <div class="container">
        <div class="card card-container">
                ...
                <input class="btn btn-lg btn-primary btn-block btn-signin" type="button" id="sendNum" value="인증번호전송"></button>
                <input class="btn btn-lg btn-primary btn-block btn-signin" type="button" id="submit" value="비밀번호찾기"></button>
