	...
	<div class="container">
		<div class="card card-container">
			...
			<form action="${pageContext.request.contextPath}/member/login" method="post">
				...
				<div class="checkbox">
					<label> <input type="checkbox" id="remember" value="remember-me"> Remember me
					</label>
				</div>
				<input class="btn btn-lg btn-primary btn-block btn-signin" type="button" id="submit" value="로그인">
				</button>
			</form>
			<br /> <a href="${pageContext.request.contextPath}/member/searchIdForm">search id</a> &nbsp; &nbsp; <a href="${pageContext.request.contextPath}/member/searchPwdForm">search password</a> &nbsp; &nbsp; <a href="${pageContext.request.contextPath}/member/joinForm">join</a><br />
		</div>
		<!-- /card-container -->
	</div>
	<!-- /container -->
