      ...
      <div class="col-md-12 col-md-offset-0">
        <div class="well well-sm">
         <form id="f" class="form-horizontal" action="${pageContext.request.contextPath}/mail/add" method="post">
					          <fieldset>
					            <legend class="text-center">e-mail</legend>
					    
					            <!-- Name input-->
					             <div class="form-group">
					              <label class="col-md-1 control-label" for="email">사람찾기</label>
					              <span class="col-md-5" id="department">
					              </span>
					                <span class="col-md-5" id="member">
					              </span>
					            </div>
					            
					            <div class="form-group">
					              <label class="col-md-1 control-label" for="name">받는사람</label>
					              <div class="col-md-10">
					            ...
					            <div class="form-group">
					              <label class="col-md-1 control-label" for="email">제목</label>
					              <div class="col-md-10">
					            ...
					            <!-- Message body -->
					            <div class="form-group">
					              <label class="col-md-1 control-label" for="message">내용</label>
					              <div class="col-md-10">
					            ...
					            <div class="form-group">
					              <div class="col-md-12 text-right">
					                ...
					                <input type="button" id="submit" class="myButton" value="메일전송">
					              </div>
					            </div>
					          </fieldset>
					          </form>
